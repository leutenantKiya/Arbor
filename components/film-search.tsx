  ...
  return (
    <>
      <button
        ...
        className="flex h-9 items-center gap-2 rounded-full border border-transparent px-2.5 text-sage transition-colors hover:border-line hover:bg-surface hover:text-cream focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber"
        aria-label="Search films"
      >
        <SearchIcon className="h-5 w-5" />
        <span className="hidden font-mono text-xs tracking-wide lg:inline">Search</span>
      </button>
            ...
            <div className="flex items-center border-b border-line px-5">
              ...
              {query && (
                <button
                  type="button"
                  onClick={() => setQuery("")}
                  className="mr-2 text-sm text-sage transition-colors hover:text-cream"
                >
                  Clear
                </button>
              )}
              <button
                type="button"
                onClick={close}
                className="hidden rounded-md border border-line px-2 py-1 font-mono text-[0.65rem] tracking-wide text-sage transition-colors hover:border-sage hover:text-cream sm:inline"
              >
                ESC
              </button>
              <button
                type="button"
                onClick={close}
                className="ml-1 rounded-md p-2 text-sage transition-colors hover:bg-surface hover:text-cream sm:hidden"
                aria-label="Close search"
              >
            ...
            <div className="overflow-y-auto px-5 py-5 sm:px-7">
              ...
              {results.length > 0 ? (
                ...
                <div className="py-10 text-center">
                  <p className="font-display text-xl text-cream">No films found</p>
                  <p className="mt-2 text-sm text-sage">Try a different title, genre, filmmaker, or year.</p>
                </div>
              )}
            </div>
          </section>
